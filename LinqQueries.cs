...
public class LinqQueries
{
    ...
    public double PromedioCharactersTitle()
    {
    ...
    {
        var BooksAfter2005 = CollectionBooks.Where(p=> p.PublishedDate.Year >2005);
        var BooksMore500Pages = CollectionBooks.Where(p=> p.PageCount >500);
